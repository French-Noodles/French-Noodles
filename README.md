...
[![My Skills](https://skillicons.dev/icons?i=androidstudio,bash,blender,bootstrap,cloudflare,html,css,discord,docker,figma,flask,git,github,godot,heroku,html,js,jquery,kotlin,linkedin,linux,md,mongodb,nginx,ps,postman,redis,regex,tailwind,vue,python,vscode,nodejs,gimp,flutter,firebase&theme=dark)](https://skillicons.dev)
